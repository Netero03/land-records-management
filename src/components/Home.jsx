...
function Home() {
  return (
    ...
    <div className=' h-screen text-left w-full flex justify-start  items-center mx-10'>
      ...
      <div className='flex justify-center items-center rounded-2xl font-bold  text-center  w-[150px] h-[50px] bg-blue-300'>
    ...
    <div className='flex justify-center'>
      ...
      <div className=' w-[250px] rounded-2xl  mx-5  flex items-center justify-center flex-col h-[300px] border-2 border-blue-400'>
      ...
      <div className='w-[250px] mx-5 rounded-2xl flex items-center justify-center flex-col h-[300px] border-2 border-blue-400'>
